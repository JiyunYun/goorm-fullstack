...
public class BoardController {
  ...
  public List<BoardListResponse> searchBoardList2(
  ...
  public BoardResponse writeBoard(
    ...
    return boardService.writeBoard(
      boardPostRequest.getTitle()
      , boardPostRequest.getBody()
    );
  }
  ...
  public BoardResponse editBoard(
    ...
    return boardService.editBoard(
      boardEditRequest.getBoardNo(),
      boardEditRequest.getBody()
    );
  }
